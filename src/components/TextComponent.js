...
const TextComponent = () => (
  <Container className="Tin-Can">
    ...
    <p>
      <i>
        Hannula, the headmaster of TUT, says that the more university improves its teaching the more
        probable is that students enter working life before graduating. [...]
      </i>
    </p>
    <p>
      <i>
        The amount of funding universities receive from the ministry of education partially depends
        on how many people graduate from there.
      </i>
    </p>
    <p>
      <i>
    ...
    <p>
      For example, if a course has a grade of 3, what does that mean? That's pretty good, right?
      In reality, it is not. The overwhelming majority (89.8% to be exact) of courses have an
      average Kaiku rating between 3 and 4.5. With this app we now have the ability to compare
      courses and with the new ranking system we have a full scale again.
    </p>
    ...
    <p>
      ...
      grade is +100%. If 20% of participants judged the course to be to intensive and 15% too
      effortless, the resulting grade is the sum of these, in this case +5%.
    </p>
    ...
    <p>
      Only the ones with 21 or more votes are graded. This is because during empirical testing it
    ...
    <p>
      Faculty-O-Meter lets you compare faculties with each other. Course ratings with same course
